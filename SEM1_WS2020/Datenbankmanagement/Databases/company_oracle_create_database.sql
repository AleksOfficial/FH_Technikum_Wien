...
ALTER TABLE DEPT_LOCATIONS
 ADD CONSTRAINT Dep_Loc_Dnumber FOREIGN KEY (Dnumber) REFERENCES DEPARTMENT(Dnumber);

ALTER TABLE PROJECT
 ADD CONSTRAINT Pro_Dnum FOREIGN KEY (Dnum) REFERENCES DEPARTMENT(Dnumber);
...
ALTER TABLE WORKS_ON
 ADD CONSTRAINT Wor_Essn FOREIGN KEY (Essn) REFERENCES EMPLOYEE(Ssn)
 ADD CONSTRAINT Wor_Pno FOREIGN KEY (Pno) REFERENCES PROJECT(Pnumber);

ALTER TABLE DEPENDENT
 ADD CONSTRAINT Dep_Essn FOREIGN KEY (Essn) REFERENCES EMPLOYEE(Ssn);
